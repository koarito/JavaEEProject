...
public class WeatherService {
 ...
 final String url = "https://api.open-meteo.com/v1/forecast?latitude="+latitude.toString()+"&longitude="+longitude.toString()+"&hourly=temperature_2m,rain,windspeed_10m";
